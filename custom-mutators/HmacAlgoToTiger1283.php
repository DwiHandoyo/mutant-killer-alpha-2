...
class HmacAlgoToTiger1283 implements Mutator
{
            ...
            if ($node->var instanceof Node\Expr\Variable && $node->var->name === 'this') {
                ...
                return [
                    new Node\Expr\Assign(
                        ...
                        new Node\Scalar\String_('tiger128,3') // New value
                    ),
                ];
            }
        }
    ...
    public static function getDefinition(): Definition
    {
        return new Definition(
            <<<'TXT'
                Replaces "$hashAlgo = 'sha256'" with "$hashAlgo = 'tiger128,3'".
                TXT,
