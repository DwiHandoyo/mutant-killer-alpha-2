...
class HashEqualsToLevenshtein implements Mutator
{
    ...
    {
        // Replace the function call "hash_equals" with "levenshtein"
        return [
            new Node\Expr\FuncCall(
                new Node\Name('levenshtein'),
                $node->args,
                $node->getAttributes()
            ),
        ];
    ...
    public static function getDefinition(): Definition
    {
        return new Definition(
            <<<'TXT'
                Replaces "hash_equals(" with "levenshtein(".
                TXT,
    ...
    {
        return 'HashEqualsToLevenshtein';
    }
}