...
class HashEqualsToStrcoll implements Mutator
{
    ...
    {
        // Replace the function call "hash_equals" with "strcoll"
        return [
            new Node\Expr\FuncCall(
                new Node\Name('strcoll'),
                $node->args,
                $node->getAttributes()
            ),
        ];
    ...
    public static function getDefinition(): Definition
    {
        return new Definition(
            <<<'TXT'
                Replaces "hash_equals(" with "strcoll(".
                TXT,
