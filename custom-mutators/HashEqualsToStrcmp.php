...
class HashEqualsToStrcmp implements Mutator
{
    ...
    {
        // Replace the function call "hash_equals" with "strcmp"
        return [
            new Node\Expr\FuncCall(
                new Node\Name('strcmp'),
                $node->args,
                $node->getAttributes()
            ),
        ];
    ...
    public static function getDefinition(): Definition
    {
        return new Definition(
            <<<'TXT'
                Replaces "hash_equals(" with "strcmp(".
                TXT,
